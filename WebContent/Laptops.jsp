...
<html lang="en">
	...
	<body>
				...
				<div class="row">
						...
						<div id="aside" class="col-md-3">
							...
							<div class="aside">
								...
								<div class="checkbox-filter">
									...
									<div class="input-checkbox">
										<input type="checkbox" id="Operating_System-1" class="Operating_System" name="Operating_System" value="MacOS">
									...
									<div class="input-checkbox">
										<input type="checkbox" id="Operating_System-2" class="Operating_System" name="Operating_System" value="Microsoft">
							...
							<div class="aside">
								<h3 class="aside-title">Graphics</h3>
								<div class="checkbox-filter">

									<div class="input-checkbox">
										<input type="checkbox" id="Graphics-1" class="Graphics" name="Graphics" value="615">
										<label for="Graphics-1">
											<span></span>
											615
										</label>
									</div>
									...
									<div class="input-checkbox">
										<input type="checkbox" id="Graphics-2" class="Graphics" name="Graphics" value="300">
										<label for="Graphics-2">
											<span></span>
											300
										</label>
									</div>
									...
									<div class="input-checkbox">
										<input type="checkbox" id="Graphics-3" class="Graphics" name="Graphics" value="500">
										<label for="Graphics-3">
											<span></span>
											500
										</label>
									</div>
									...
									<div class="input-checkbox">
										<input type="checkbox" id="Graphics-4" class="Graphics" name="Graphics" value="AMD">
										<label for="Graphics-4">
											<span></span>
											AMD
										</label>
									</div>
							...
							<div class="aside">
								<h3 class="aside-title">Storage Type</h3>
								<div class="checkbox-filter">

									<div class="input-checkbox">
										<input type="checkbox" id="Storage_Type-1" class="Storage_Type" name="Storage_Type" value="SSD">
										<label for="Storage_Type-1">
											<span></span>
											SSD
											<small>(120)</small>
										</label>
									...
									<div class="input-checkbox">
										<input type="checkbox" id="Storage_Type-2" class="Storage_Type" name="Storage_Type" value="HDD">
										<label for="Storage_Type-2">
											<span></span>
											HDD
											<small>(740)</small>
										</label>
					...
					<div id="store" class="col-md-9">
						...
						try{
							...
							if (brand == null && year == null && color == null && condition == null && graphics == null && storage_capacity == null && screen_size == null && operating_system == null && ram == null && storage_type == null){ 
								...
								String query1 = "SELECT * FROM Electronics_Laptop l, Electronics e, AFP a where l.item_id = e.item_id and a.item_id = e.item_id";
								...
								<div class="col-md-4 col-xs-6">
									<div class="product">
										<div class="product-body">
											...
											<h4 class="product-graphics"><% out.print("Graphics: " + rs.getString("graphics")); %></a></h4>
											...
											<h8 class="product-storage_type"><% out.print("Storage Type: " + rs.getString("storage_type")); %> </h8>
							...
							String query1 = "SELECT * FROM Electronics_Laptop l, Electronics e, AFP a where l.item_id = e.item_id and a.item_id = e.item_id AND ";
							...
							if (brand != null){
								...
								if (year != null){
									...
									if (color != null){
										...
										if (condition != null){
											...
											if (graphics != null){
												query1 = query1 + " AND graphics = " + "'" + graphics + "'";
														...
														if (operating_system != null){
															...
															if (ram != null){
																...
																if (storage_type != null){
																	query1 = query1 + " AND storage_type = " + "'" + storage_type + "'";
																}
															}
														}
													}
								...
								query1 = query1 + "graphics = " + "'" + graphics + "'";
								if (storage_capacity != null){
									query1 = query1 + " AND storage_capacity = " + "'" + storage_capacity + "'";
									if (screen_size != null){
										query1 = query1 + " AND screen_size = " + "'" + screen_size + "'";
    	...
    	$('.Graphics').on('change', function(){
    		$('.Graphics').not(this).prop('checked', false);
    	});

    	$('.Storage_Type').on('change', function(){
    		$('.Storage_Type').not(this).prop('checked', false);
    	});
